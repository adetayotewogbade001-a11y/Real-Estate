...
export const PropertiesView: React.FC<PropertiesViewProps> = ({
  ...
  return (
    <div className="space-y-10 pb-12 text-slate-900">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 text-white flex flex-col items-start text-left">
          <div className="max-w-2xl space-y-4 flex flex-col items-start text-left">
            <div className="inline-flex items-center gap-2 bg-[#B48C4E]/20 border border-[#B48C4E]/30 px-3.5 py-1.5 rounded-sm text-xs font-semibold text-[#B48C4E]">
              ...
              <span className="text-[10px] uppercase font-bold tracking-widest">Newry & Mourne Property Database</span>
            </div>
            ...
            <p className="text-slate-300 text-xs sm:text-sm leading-relaxed text-left">
              Browse residential sales, lettings, and commercial listings from Morgan Property Services. Filter by location, price, and property style.
            </p>
            ...
            <div className="pt-2 flex flex-wrap items-center justify-start gap-3 w-full">
              ...
              >
                ...
                <span>Saved Listings ({savedPropertyIds.length})</span>
              </button>
      ...
      {/* Filter Sidebar & Main Grid Layout */}
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="bg-white border border-slate-200 rounded-sm p-5 space-y-5 h-fit shadow-sm">
          ...
          <div className="space-y-1">
            ...
            <select
              ...
              className="w-full bg-slate-50 border border-slate-200 rounded-sm px-3 py-2 text-xs text-slate-900 focus:border-[#B48C4E] focus:outline-none font-medium"
            >
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          {/* Active Filter Bar & View Toggles */}
          <div className="bg-white border border-slate-200 rounded-sm p-3 px-4 flex flex-wrap items-center justify-between gap-3 text-xs shadow-sm">
            <div className="text-slate-600 font-medium">
              Showing <strong className="text-[#0F172A] font-bold">{filteredProperties.length}</strong> properties
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-slate-50 border border-slate-200 rounded-sm px-2.5 py-1 text-xs text-slate-900 focus:outline-none font-medium"
                >
              ...
              <div className="flex bg-slate-100 p-1 rounded-sm border border-slate-200">
                <button
                  ...
                  className={`p-1 rounded-sm transition-colors cursor-pointer ${
                    viewMode === 'grid' ? 'bg-[#0F172A] text-white' : 'text-slate-500 hover:text-black'
                  }`}
                  title="Grid View"
                >
                ...
                <button
                  ...
                  className={`p-1 rounded-sm transition-colors cursor-pointer ${
                    viewMode === 'list' ? 'bg-[#0F172A] text-white' : 'text-slate-500 hover:text-black'
                  }`}
                  title="List View"
                >
